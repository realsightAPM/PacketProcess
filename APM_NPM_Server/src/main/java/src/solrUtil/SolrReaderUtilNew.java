...
public class SolrReaderUtilNew  implements InitializingBean,AutoCloseable {
	...
	private static Log logger  = LogFactory.getLog(SolrReaderUtilNew.class); 
	...
	public SolrReaderUtilNew setQueryField(String[] queryFields){
		this.queryFields = queryFields;
		return this;
	}
	
	public SolrReaderUtilNew  setQueryRows(int rows){
		this.rows = rows;
		return this;
	}
	
	public SolrReaderUtilNew setQueryfacetField(String facetField){
		this.facetField = facetField;
		return this;
	}
	
	public SolrReaderUtilNew setQueryStatsFacet(String statsFacet){
		this.statsFacet = statsFacet;
		return this;
	}
	
	public SolrReaderUtilNew setQuerystatsFields(String[] statsFields){
		this.statsFields = statsFields;
		return this;
	}
	
	public SolrReaderUtilNew setQueryFilters(String[] filters){
		this.filters = filters;
		return this;
	}
	
	public SolrReaderUtilNew setQueryParam(String query){
		this.query = query;
		return this;
	}
